...
#define gamebg_TILE_COUNT 160
#define gamebg_PALETTE_COUNT 1
#define gamebg_COLORS_PER_PALETTE 4
#define gamebg_TOTAL_COLORS 4
...
extern const palette_color_t gamebg_palettes[4];
extern const uint8_t gamebg_tiles[2560];
